                ...
                <nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <div id="main-nav" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav" id="mainNav">
                            ...
                            <li><a href="<?php echo base_url(); ?>index.php/RegKonController" class="scroll-link">Registruj se kao konobar</a></li>
                            <li><a href="<?php echo base_url(); ?>index.php/RegRestController" class="scroll-link">Registruj se kao restoran </a></li>
