                ...
                <nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <div id="main-nav" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav" id="mainNav">
                            ...
                            <li class="active"><a href="<?php echo base_url() . 'index.php/EditovanjeNalogaCtrl'; ?>" class="scroll-link">Izmena profila</a></li>
                    ...
                    <div class="col-sm-8 col-sm-offset-2" >
                        <form action="<?php echo(base_url()); ?>index.php/EditovanjeNalogaCtrl/confirm" method="POST" role="form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"    name="username" placeholder="Unesite vase korisničko ime ovde" value = "<?php print $user['KIme'] ?>" disabled="">
                                ...
                                <input type="text" class="form-control"  placeholder="Unesite kod dobijen od poslodavca" name="kod" value = "<?php print $user['']; ?>" disabled="">
                                -->
