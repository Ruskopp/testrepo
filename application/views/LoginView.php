                ...
                <nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <div id="main-nav" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav" id="mainNav">
                            <li class="active"><a href="<?php echo base_url(); ?>index.php/HomeCtrl" class="">Napusti logovanje</a></li>
                        </ul>
                    </div>
                    <!--/.navbar-collapse--> 
                </nav>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2" >
                        <form action="<?php echo base_url(); ?>index.php/LoginCtrl/submit" method="POST" role="form">
