            ...
            <div class="col-sm-9">
                 <?php foreach ($konobari as $konobar) { ?>
                            <div class="jumbotron" style="background-color:rgba(237, 231, 227, 0.87)">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <img src="<?php echo base_url(); ?>images/slides/photo-1.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236">
                                    </div>
                                    <div class="col-sm-8">
                                        <h2>
                                            <?php echo $konobar['Ime'].' '.$konobar['Prezime']; ?>
                                        </h2>
                                        <p>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a href="<?php echo base_url().'index.php/OtpustanjeKonobaraCtrl/AreYouSure/'.$konobar['IDKonobar'] ?>" class="btn btn-warning btn-lg">Otpusti konobara</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>   
