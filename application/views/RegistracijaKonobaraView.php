            ...
            <div clas="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2" >
                        <form action="<?php echo(base_url()); ?>index.php/RegistracijaKonobaraCtrl/submit" method="POST" role="form">
                            <div class="form-group">
                                <legend>Registracija konobara</legend>
                                <?php echo form_error('username'); ?>
                                <label for="">Korisničko ime</label>
                                <input type="text" class="form-control"    name="username" placeholder="Unesite vase korisničko ime ovde" value = "<?php echo set_value('username'); ?>">
